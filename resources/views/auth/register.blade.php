        ...
        <div class="pauth-form-panel">
          ...
          <form class="pauth-form" id="signupForm" method="POST" action="{{ route('register') }}">
            ...
            <div class="pauth-field">
              <input class="pauth-input @error('name') is-invalid @enderror" id="signupName" name="name" type="text" placeholder=" " value="{{ old('name') }}" autocomplete="name" required>
            ...
            <div class="pauth-field">
              <input class="pauth-input @error('email') is-invalid @enderror" id="signupEmail" name="email" type="email" placeholder=" " value="{{ old('email') }}" autocomplete="email" required>
            ...
            <div class="pauth-field">
              <input class="pauth-input @error('password') is-invalid @enderror" id="signupPassword" name="password" type="password" placeholder=" " autocomplete="new-password" required>
              <label class="pauth-label" for="signupPassword">Password</label>
              <button class="pauth-pass-toggle" type="button" data-toggle-password="signupPassword" aria-label="Show password">
            ...
            <div class="pauth-field">
              <input class="pauth-input" id="signupConfirm" name="password_confirmation" type="password" placeholder=" " autocomplete="new-password" required>
              <label class="pauth-label" for="signupConfirm">Confirm password</label>
              <button class="pauth-pass-toggle" type="button" data-toggle-password="signupConfirm" aria-label="Show password">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-7 11-7 11 7 11 7-4 7-11 7S1 12 1 12Z"/><circle cx="12" cy="12" r="3"/></svg>
              </button>
          ...
          <p class="pauth-switch">Already have an account? <a class="pauth-link" href="{{ route('login') }}">Login</a></p>
        </div>
      </div>
    </section>
  </main>
