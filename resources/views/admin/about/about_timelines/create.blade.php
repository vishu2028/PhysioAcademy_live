...
@section('title', 'Add About Timeline')
...
<div class="mb-4">
    ...
    <p class="text-secondary mb-0">
        Create a new timeline entry for the About section.
    </p>
...
<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
    ...
    <div class="card-body p-4">
        ...
        <form action="{{ route('admin.about_timelines.store') }}"
              method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-8 mb-3">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('title') }}"
                           placeholder="New Curriculum Coverage"
                           required>
