...
<div class="mb-4 d-flex justify-content-between align-items-center">
    <div>
        ...
        <p class="text-secondary">Feedback from physiotherapy students using the platform.</p>
    </div>
</div>
    ...
    <tr>
        ...
        <td>
            <div class="d-flex gap-2">
                <a href="{{ route('admin.testimonials.edit', $testimonial) }}" class="btn btn-primary btn-sm rounded-3"><i class="bi bi-pencil"></i></a>
