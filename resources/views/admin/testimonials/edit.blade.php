...
<div class="mb-4">
    ...
    <h2 class="fw-bold text-dark mt-2">{{ isset($testimonial) ? 'Edit Testimonial' : 'Add New Testimonial' }}</h2>
</div>
            ...
            <div class="row g-4">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="content" class="form-control rounded-3" rows="4" placeholder="What the student said..." required>{{ old('content', $testimonial->content ?? '') }}</textarea>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-check form-switch mt-4 pt-2">
                                <input class="form-check-input" type="checkbox" name="status" id="statusSwitch" value="1" {{ old('status', $testimonial->status ?? true) ? 'checked' : '' }}>
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="order" class="form-control rounded-3" value="{{ old('order', $testimonial->order ?? 0) }}">
                    </div>
                </div>
            </div>
