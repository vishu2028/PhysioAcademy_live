...
@section('title', 'Edit Recent Activity')
...
<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
    ...
    <div class="card-body p-4">
        ...
        <form action="{{ route('admin.community.update', $communityActivity->id) }}"
              method="POST">
                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('title', $communityActivity->title) }}"
                               required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('subject', $communityActivity->subject) }}"
                               required>
                    ...
                    <div class="card bg-light border-0 rounded-4 p-3 h-100">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('time', $communityActivity->time) }}"
                                   required>
                        ...
                        {{-- <div class="mb-3">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('icon', $communityActivity->icon) }}"
                                   required>
