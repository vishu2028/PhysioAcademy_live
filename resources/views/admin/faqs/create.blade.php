...
<div class="mb-4">
    ...
    <h2 class="fw-bold text-dark">Add New FAQ</h2>
    <p class="text-secondary">Create a new question and answer for the frontend FAQ section.</p>
</div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="mb-3">
                        ...
                        <input type="text" name="question" class="form-control rounded-3 py-2 @error('question') is-invalid @enderror" value="{{ old('question') }}" placeholder="What is Physio Academy?" required>
                        @error('question')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="answer" class="form-control rounded-3 @error('answer') is-invalid @enderror" rows="8" placeholder="Detailed answer here..." required>{{ old('answer') }}</textarea>
                        @error('answer')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="card bg-light border-0 rounded-4 p-3 h-100">
                        ...
                        <div class="mt-auto">
                            <button type="submit" class="btn btn-primary w-100 py-3 rounded-3 fw-bold">
                                <i class="bi bi-cloud-upload d-block fs-4 mb-1"></i> Save FAQ
                            </button>
                        </div>
                    </div>
                </div>
