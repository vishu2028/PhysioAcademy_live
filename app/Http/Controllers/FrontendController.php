...
class FrontendController extends Controller
{
    ...
    {
        $hero = \App\Models\HeroSection::active()->first();
    ...
    public function about()
    {
        ...
        $sections = \App\Models\PageSection::where('page_id', $page->id)->where('enabled', true)->orderBy('order')->get();
        $pageProtected = $page->is_protected;
        return view('about', compact('page', 'sections', 'pageProtected'));
    }
